...
namespace FerPROJ.Design.Forms {
    public class FrmListGridKryptonLoadApi<TModel, TEntity> : FrmListGridKrypton where TModel : BaseModel {
        ...
        public FrmListGridKryptonLoadApi(Type repoType, CrudOptions crudOptions, Expression<Func<TEntity, bool>> searchParameter = null, Func<TModel, bool> searchParameterModel = null) : base(repoType, crudOptions) {
