namespace FerPROJ.Design.Class
{
    public static class CSet
    {
        ...
        public static void SetEntityConnectionString(string Hostname, string Username, string Password, string Port, string Database) {
            CStaticVariable.entityConnString = $"server={Hostname};user id={Username};port={Port};persistsecurityinfo=True;database={Database};password={Password};";
        }
    }
}
