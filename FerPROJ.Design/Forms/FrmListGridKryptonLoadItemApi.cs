...
namespace FerPROJ.Design.Forms {
    public class FrmListGridKryptonLoadItemApi<TModel, TEntity> : FrmListGridKrypton where TModel : BaseModelItem {
        private readonly Expression<Func<TEntity, bool>> _searchParameter;
        public FrmListGridKryptonLoadItemApi(Type repoType, CrudOptions crudOptions, Expression<Func<TEntity, bool>> searchParameter = null) : base(repoType, crudOptions) {
