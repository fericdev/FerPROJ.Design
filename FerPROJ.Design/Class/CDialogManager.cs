...
namespace FerPROJ.Design.Class
{
    public static class CDialogManager
    {
        ...
        public static bool Ask(string message) {
            if (MessageBox.Show(message, CBaseAssembly.SystemName, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes) {
                return true;
            }
            return false;
        }
        ...
        public static void Warning(string message) {
            MessageBox.Show(message, CBaseAssembly.SystemName, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        ...
        public static void Info(string message) {
            MessageBox.Show(message, CBaseAssembly.SystemName, MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
